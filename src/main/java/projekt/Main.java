...
public class Main 
{
    public static void main( String[] args )
    {
		...
		double swch = funSchwefel.wykonaj(420.9687, 420.9687); //  wynik =0
//		 double swch1 = funkcja.wykonaj(0,0);
        ...
        Wyzarzanie wyzarzanie3 = new Wyzarzanie(funRastrigin, 3000000, 0.93, -1, 1, 500000);
        Wyzarzanie wyzarzanie4 = new Wyzarzanie(funSchwefel, 3500000, 0.85, -500, 500, 2000000);
