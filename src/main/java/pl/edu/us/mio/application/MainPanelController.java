...
import pl.edu.us.mio.projekt.NazwaAlgorytmu;
import pl.edu.us.mio.projekt.NazwaFunkcji;
import pl.edu.us.mio.projekt.algorytmy.Algorytm;
...
import pl.edu.us.mio.projekt.funkcje.F_Ackley;
import pl.edu.us.mio.projekt.funkcje.F_Rosenbrocks;
...
//                txtPrzedzialOd.textProperty().set(String.valueOf(newValue.intValue()));
                ...
                txtPrzedzialOd.setText(i.toString());
        ...
        txtPrzedzialOd.textProperty().addListener(new ChangeListener<String>() {
            ...
            public void changed(ObservableValue<? extends String> observable, String oldValue, String newValue) {
                ...
                try {
                    ...
                    if (i >= slPrzedzialOd.getMin() && i <= slPrzedzialOd.getMax()) {
                        slPrzedzialOd.valueProperty().set(i);
                        // do what you want with this i
                    } else {
                        ((StringProperty) observable).setValue(oldValue);
                    }
...
//        txtPrzedzialOd.setText(String.valueOf(funkcja.getPrzedzialOd()));
